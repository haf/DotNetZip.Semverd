                            ...
                            using (Process p = Process.Start(startInfo))
                            {
                                if (p!=null)
                                {
                                    ...
                                    if (p.ExitCode == 0)
                                    {
                                        ...
                                        {
	                                        if (!targetDirectoryExistsBeforehand)
	                                        {
		                                        try
		                                        {
			                                        //This directory was created from extracting, simply delete it
	                                        ...
	                                        {
												//Directory already exists, there may have been some files that
												//weren't overwritten, so go through each item that was actually
												//extracted and delete them
